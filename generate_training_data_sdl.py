...
SPEC_SIZE = 512 ## NxN input tensor size

#input_folder = "/home/jonathan/HF_Dataset"
input_folder = "/home/jonathan/meteordoctor_dataset_2"
...
def feature_gen(file_list, spec_size):
    ...
    for filename in file_list:
        ...
        #Big fix needed as the whole BW of audio file is saved - TODO
        
        ###
        
        
        #feature_dict = sdl.generate_features(fs, iq_data, spec_size, plot_features = False)
        mag = mdl.generate_mag_feature(fs, iq_data,spec_xy=SPEC_SIZE)
